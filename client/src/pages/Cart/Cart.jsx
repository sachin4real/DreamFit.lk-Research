      ...
      <div className="p-4 bg-white rounded-lg shadow-md">
        ...
        {loading ? (
          ...
          <div className="text-center">
            ...
            />
            <p className="text-md text-gray-600">Your cart is empty. Time to explore more!</p>
            <button
                  ...
                  {cartItems.map((item) => (
                    <tr key={item._id} className="border-b border-gray-300">
                      <td className="py-4 px-4 flex items-center space-x-4">
                        ...
                        />
                        <div>
                          <span className="font-bold text-md text-gray-800">{item.ItemName}</span>
                          <p className="text-sm text-gray-500">Rs {item.ItemPrice}</p>
            ...
            <div className="col-span-1">
              <div className="bg-gray-100 p-4 rounded-lg shadow-xl">
                ...
                <div className="flex justify-between text-md mb-6">
                  ...
                  <span className="font-bold text-xl">Rs {cartTotal.toFixed(2)}</span>
                </div>
                <button
